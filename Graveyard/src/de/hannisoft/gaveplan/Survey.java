...
/**
 * This class determines if the user has complaints. If not, it jumps to the last page of the wizard.
 */
...
class MoreInformationPage extends WizardPage {
    ...
    Parent getContent() {
        ...
        return VBoxBuilder.create().spacing(5).children(new Label("Please enter your complaints."), textArea).build();
    }
}
